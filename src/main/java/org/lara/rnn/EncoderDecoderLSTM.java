...
public class EncoderDecoderLSTM {
    ...
    private static final String CONTEXT_PATH = "/home/louis/Bureau/Lara/RES/"; // filename of data corpus to learn
    ...
    private void startDialog(Scanner scanner) throws IOException {
        ...
        while (true) {
            ...
            Context context = new Cornell(CONTEXT_PATH + "movie_lines.txt", CONTEXT_PATH + "movie_conversations.txt", 0, ROW_SIZE);
            context.init();
            CorpusProcessor dialogProcessor = new CorpusProcessor(context, ROW_SIZE, false) {
                @Override
    ...
    private void createDictionary() throws IOException {
        ...
        Context context = new Cornell(CONTEXT_PATH + "movie_lines.txt", CONTEXT_PATH + "movie_conversations.txt", 0, ROW_SIZE);
        context.init();
        CorpusProcessor corpusProcessor = new CorpusProcessor(context, ROW_SIZE, true);
        ...
        corpusProcessor = new CorpusProcessor(context, ROW_SIZE, false) {
            @Override
            protected void processLine(String lastLine) {
                List<String> words = new ArrayList<>();
                tokenizeLine(lastLine, words, true);
